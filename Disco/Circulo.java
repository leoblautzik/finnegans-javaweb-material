package finnegans.encapsulamiento;

public class Circulo implements Movible{
	
	private Double radio;
	private Punto puntoDeAplicacion;

	public Circulo(double radio , Punto pda) {
		setRadio(radio);
		setPuntoDeAplicacion(pda);
	}
	
	public void mover(double deltaX, double deltaY) {
		this.setPuntoDeAplicacion(this.puntoDeAplicacion.mover(deltaX, deltaY));
	}
	...
	public static void main(String[] args) {
		...
		Circulo circulito = new Circulo(1, new Punto(5,-4));
